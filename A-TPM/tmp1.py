...
class MaskingWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.vlayout.addWidget(self.canvas, 15)  # 画布添加到窗口布局中
        self.vlayout.addWidget(self.control_bar_frame, 1)
        # self.win_vlayout.addWidget(self.figtoolbar)  # 工具栏添加到窗口布局中

        # self.setLayout(self.win_vlayout)
    ...
    def playSwitch(self):
        if self.is_pause:
            ...
            self.bnt_playControl.setIcon(icon)
    ...
    def ani_control(self):
        ...
        # Play Button
        # ////////////////////////////////////////////////////////////////////////
        self.bnt_playControl = QPushButton()
        icon_play = QIcon(Functions.set_svg_icon("icon_stop.svg"))
        self.bnt_playControl.setIcon(icon_play)
        # Back Button
        # ////////////////////////////////////////////////////////////////////////
        ...
        self.bnt_playControl.clicked.connect(self.playSwitch)
        self.btn_oneforward.clicked.connect(self.ani.oneforward)

        self.btn_test = QPushButton("test")
        # self.btn_test.clicked.connect(self.ani.stop)

        hlayout = QHBoxLayout(self.control_bar_frame)
        hlayout.addWidget(self.btn_oneback)
        hlayout.addWidget(self.bnt_playControl)
        hlayout.addWidget(self.btn_oneforward)
        hlayout.addWidget(self.btn_test)
        return
