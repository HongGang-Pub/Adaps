...
class Table(QWidget):
    ...
    def getValue(self):
        ...
        for idx in range(self.TableWidget.rowCount()):
            print(idx)
            print('姓名：' + self.TableWidget.item(idx, 0).text())
            # print('性别：' + self.TableWidget.cellWidget(idx, 1).currentText())
            print('性别：' + self.TableWidget.cellWidget(idx, 1).text())
