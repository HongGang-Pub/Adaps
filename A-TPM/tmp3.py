...
class QTableWidgetDemo(QMainWindow):
    ...
    def generateMenu(self):
        ...
        menu.addAction(QIcon("images/close.png"), '删除行', lambda: self.onDelete('row'),
        ...
        menu.addAction('选择行', lambda: self.tableWidget.selectRow(self.tableWidget.currentRow()),
                       QKeySequence(Qt.CTRL | Qt.Key_R))
        menu.addAction('选择列', lambda: self.tableWidget.selectColumn(self.tableWidget.currentColumn()),
