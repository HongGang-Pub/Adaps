...
class Swan01MainUI:
    ...
    def setup_script_gui_switch(self):
        ...
        self.ui.load_pages.Swan01_MIPI_CLOCK_MODE_ComboBox.setCurrentIndex(self.swan01_config['MIPI_CLOCK_MODE'])
    ...
    def setup_script_gui_ini(self):
        ...
        self.ui.load_pages.Swan01_MIPI_CLOCK_MODE_ComboBox.currentIndexChanged.connect(partial(Swan01MainUI.combobox_data_update, self, 'MIPI_CLOCK_MODE'))
