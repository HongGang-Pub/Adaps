...
################################################################################
## Form generated from reading UI file 'main_pagespxHsLg.ui'
##
...
class Ui_MainPages(object):
    def setupUi(self, MainPages):
        ...
        self.Hawk01_XCLK_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Hawk01_MST_MODE_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Hawk01_WORK_MODE_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_WORK_MODE_Label.setFrameShadow(QFrame.Raised)
        self.Hawk01_WORK_MODE_Label.setMargin(0)

        self.formLayout_2.setWidget(3, QFormLayout.LabelRole, self.Hawk01_WORK_MODE_Label)
        ...
        self.formLayout_2.setWidget(3, QFormLayout.FieldRole, self.Hawk01_WORK_MODE_ComboBox)
        ...
        self.Hawk01_MIPI_RATE_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_MIPI_RATE_Label.setFrameShadow(QFrame.Raised)

        self.formLayout_2.setWidget(4, QFormLayout.LabelRole, self.Hawk01_MIPI_RATE_Label)
        ...
        self.formLayout_2.setWidget(4, QFormLayout.FieldRole, self.Hawk01_MIPI_RATE_ComboBox)
        ...
        self.gridLayout.addWidget(self.Hawk01_V_PXL_OUT_NUM_ComboBox, 1, 1, 1, 1)
        ...
        self.Hawk01_TRG_I_EN_Label.setMaximumSize(QSize(85, 16777215))
        self.Hawk01_TRG_I_EN_Label.setFont(font)
        self.Hawk01_TRG_I_EN_Label.setFrameShape(QFrame.StyledPanel)

        self.gridLayout.addWidget(self.Hawk01_TRG_I_EN_Label, 1, 3, 1, 1)
        ...
        self.Hawk01_OUT_BIN_NUM_Lable.setFrameShape(QFrame.StyledPanel)

        self.gridLayout.addWidget(self.Hawk01_OUT_BIN_NUM_Lable, 3, 0, 1, 1)
        ...
        self.Hawk01_SYS_CLK_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_SYS_CLK_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Hawk01_PKS_ECHO_NUM_Lable.setFrameShape(QFrame.StyledPanel)

        self.gridLayout.addWidget(self.Hawk01_PKS_ECHO_NUM_Lable, 3, 3, 1, 1)
        ...
        self.Hawk01_MINBIN_THRS_Lable.setFrameShape(QFrame.StyledPanel)

        self.gridLayout.addWidget(self.Hawk01_MINBIN_THRS_Lable, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Hawk01_PKS_ECHO_NUM_ComboBox, 3, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.Hawk01_MAXBIN_THRS_spinBox, 2, 5, 1, 1)
        ...
        self.Hawk01_MAXBIN_THRS_Lable_.setFrameShape(QFrame.StyledPanel)

        self.gridLayout.addWidget(self.Hawk01_MAXBIN_THRS_Lable_, 2, 3, 1, 1)
        ...
        self.Hawk01_V_PXL_OUT_NUM_Label.setMaximumSize(QSize(85, 16777215))
        self.Hawk01_V_PXL_OUT_NUM_Label.setFont(font)
        self.Hawk01_V_PXL_OUT_NUM_Label.setFrameShape(QFrame.StyledPanel)

        self.gridLayout.addWidget(self.Hawk01_V_PXL_OUT_NUM_Label, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Hawk01_TRG_I_EN_ComboBox, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.Hawk01_MINBIN_THRS_spinBox, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Hawk01_OUT_BIN_NUM_ComboBox, 3, 1, 1, 1)
        ...
        self.Hawk01_BIN_NUMBER_Value.setMinimumSize(QSize(25, 25))
        self.Hawk01_BIN_NUMBER_Value.setMaximumSize(QSize(20, 16777215))
        self.Hawk01_BIN_NUMBER_Value.setFont(font1)
        self.Hawk01_BIN_NUMBER_Value.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.Hawk01_BIN_NUMBER_Value.setWordWrap(True)
        self.Hawk01_BIN_NUMBER_Value.setMargin(0)

        self.gridLayout.addWidget(self.Hawk01_BIN_NUMBER_Value, 2, 6, 1, 1)
        ...
        self.Hawk01_TDC_BIN_W_Label.setFrameShape(QFrame.StyledPanel)

        self.gridLayout.addWidget(self.Hawk01_TDC_BIN_W_Label, 0, 3, 1, 1)


        self.formLayout_2.setWidget(5, QFormLayout.SpanningRole, self.Hawk01_MoreConfiguration)

        self.Hawk01_TX_FRM_MODE_Label = QLabel(self.Hawk01_RegisterConfig)
        ...
        self.Hawk01_TX_FRM_MODE_Label.setMaximumSize(QSize(85, 16777215))
        self.Hawk01_TX_FRM_MODE_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_TX_FRM_MODE_Label.setMargin(0)

        self.formLayout_2.setWidget(2, QFormLayout.LabelRole, self.Hawk01_TX_FRM_MODE_Label)

        self.Hawk01_TX_FRM_MODE_ComboBox = QComboBox(self.Hawk01_RegisterConfig)
        ...
        self.formLayout_2.setWidget(2, QFormLayout.FieldRole, self.Hawk01_TX_FRM_MODE_ComboBox)
        ...
        self.Hawk01_SCAN_MODE_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_SCAN_MODE_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Hawk01_V_ROLL_NUM_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_V_ROLL_NUM_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Hawk01_H_ROLL_NUM_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_H_ROLL_NUM_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Hawk01_H_VLD_SEG_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_H_VLD_SEG_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Hawk01_H_ROLL_NUM_Slider.setOrientation(Qt.Horizontal)
        ...
        self.Hawk01_H_ROLL_NUM_Value.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.Hawk01_V_ROLL_NUM_Slider.setMouseTracking(False)
        ...
        self.Hawk01_V_ROLL_NUM_Slider.setOrientation(Qt.Horizontal)
        ...
        self.Hawk01_V_ROLL_NUM_Value.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.Hawk01_H_VLD_SEG_Slider.setOrientation(Qt.Horizontal)
        ...
        self.Hawk01_H_VLD_SEG_Value.setTextFormat(Qt.MarkdownText)
        self.Hawk01_H_VLD_SEG_Value.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.scrollArea = QScrollArea(self.Hawk01_Config1byGUI)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 348, 410))
        ...
        self.Hawk01_seg_hs_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_seg_hs_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_seg_hs_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.Hawk01_seg_hs_Label)

        self.Hawk01_seg_hs_spinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_spad_vs_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_spad_vs_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_spad_vs_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.Hawk01_spad_vs_Label)

        self.Hawk01_spad_vs_spinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_light_shift_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_light_shift_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_light_shift_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.Hawk01_light_shift_Label)

        self.Hawk01_light_shift_spinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_sublight_shift_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_sublight_shift_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_sublight_shift_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.Hawk01_sublight_shift_Label)

        self.Hawk01_sublight_shift_spinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_ROI_Shape_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_ROI_Shape_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_ROI_Shape_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.Hawk01_ROI_Shape_Label)

        self.Hawk01_ROI_Shape_ComboBox = NoWheelComboBox(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_v_spad_shift_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_v_spad_shift_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_v_spad_shift_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(8, QFormLayout.LabelRole, self.Hawk01_v_spad_shift_Label)

        self.Hawk01_v_spad_shift_spinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_h_seg_shift_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_h_seg_shift_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_h_seg_shift_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.Hawk01_h_seg_shift_Label)

        self.Hawk01_h_seg_shift_spinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_ROI_Retrace_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_ROI_Retrace_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_ROI_Retrace_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(7, QFormLayout.LabelRole, self.Hawk01_ROI_Retrace_Label)

        self.Hawk01_ROI_Retrace_ComboBox = NoWheelComboBox(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_sublight_group_Label = QLabel(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_sublight_group_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_sublight_group_Label.setFrameShadow(QFrame.Raised)

        self.formLayout.setWidget(4, QFormLayout.LabelRole, self.Hawk01_sublight_group_Label)

        self.Hawk01_sublight_group_LineEdit = QLineEdit(self.scrollAreaWidgetContents_2)
        ...
        self.Hawk01_sublight_group_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.scrollArea_2 = QScrollArea(self.Hawk01_Config2byCOOR)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 348, 410))
        ...
        self.Hawk01_Cali_File_Load_Label = QLabel(self.scrollAreaWidgetContents_3)
        ...
        self.Hawk01_Cali_File_Load_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_Cali_File_Load_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Hawk01_Cali_File_Load_LineEdit = QLineEdit(self.scrollAreaWidgetContents_3)
        ...
        self.Hawk01_Cali_File_Load_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.Hawk01_Cali_File_Load_Button = QPushButton(self.scrollAreaWidgetContents_3)
        ...
        self.Hawk01_Cali_File_Load_Button.setFocusPolicy(Qt.WheelFocus)
        ...
        self.Hawk01_Excel_Sheet_sel_Label = QLabel(self.scrollAreaWidgetContents_3)
        ...
        self.Hawk01_Excel_Sheet_sel_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_Excel_Sheet_sel_Label.setFrameShadow(QFrame.Raised)

        self.formLayout_4.setWidget(1, QFormLayout.LabelRole, self.Hawk01_Excel_Sheet_sel_Label)

        self.Hawk01_Excel_Sheet_sel_spinBox = QSpinBox(self.scrollAreaWidgetContents_3)
        ...
        self.scrollArea_3 = QScrollArea(self.Hawk01_Config3ROIEdit)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 348, 410))
        ...
        self.Hawk01_ROI_File_Label = QLabel(self.scrollAreaWidgetContents_4)
        ...
        self.Hawk01_ROI_File_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Hawk01_ROI_File_LineEdit = QLineEdit(self.scrollAreaWidgetContents_4)
        ...
        self.Hawk01_ROI_File_LineEdit.setFocusPolicy(Qt.StrongFocus)
        self.Hawk01_ROI_File_LineEdit.setReadOnly(True)

        self.Hawk01_ROI_File_Layout.addWidget(self.Hawk01_ROI_File_LineEdit)

        self.Hawk01_ROI_File_Button = QPushButton(self.scrollAreaWidgetContents_4)
        ...
        self.Hawk01_ROI_File_Button.setFocusPolicy(Qt.WheelFocus)
        ...
        self.Hawk01_Start_Rolling_Label = QLabel(self.scrollAreaWidgetContents_4)
        ...
        self.Hawk01_Start_Rolling_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_Start_Rolling_Label.setFrameShadow(QFrame.Raised)
        self.Hawk01_Start_Rolling_Label.setTextFormat(Qt.PlainText)

        self.formLayout_5.setWidget(1, QFormLayout.LabelRole, self.Hawk01_Start_Rolling_Label)

        self.Hawk01_End_Rolling_Label = QLabel(self.scrollAreaWidgetContents_4)
        ...
        self.Hawk01_End_Rolling_Label.setFrameShape(QFrame.StyledPanel)
        self.Hawk01_End_Rolling_Label.setFrameShadow(QFrame.Raised)

        self.formLayout_5.setWidget(2, QFormLayout.LabelRole, self.Hawk01_End_Rolling_Label)

        self.Hawk01_End_Rolling_SpinBox = QSpinBox(self.scrollAreaWidgetContents_4)
        ...
        self.Hawk01_Start_Rolling_SpinBox = QSpinBox(self.scrollAreaWidgetContents_4)
        ...
        self.scrollArea_5 = QScrollArea(self.Hawk01_Config4ROICali)
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QRect(0, 0, 348, 401))
        ...
        self.Hawk01_cali_file_path_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_cali_file_path_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Hawk01_cali_file_path_LineEdit = QLineEdit(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_cali_file_path_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.Hawk01_cali_file_path_Button = QPushButton(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_cali_file_path_Button.setFocusPolicy(Qt.WheelFocus)
        ...
        self.Hawk01_img_mirror_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_img_mirror_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(1, QFormLayout.LabelRole, self.Hawk01_img_mirror_Label)

        self.Hawk01_img_mirror_ComboBox = NoWheelComboBox(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_remove_noise_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_remove_noise_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(2, QFormLayout.LabelRole, self.Hawk01_remove_noise_Label)

        self.Hawk01_remove_noise_ComboBox = NoWheelComboBox(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_light_smooth_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_light_smooth_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(3, QFormLayout.LabelRole, self.Hawk01_light_smooth_Label)

        self.Hawk01_light_smooth_ComboBox = NoWheelComboBox(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_curvature_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_curvature_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(4, QFormLayout.LabelRole, self.Hawk01_curvature_Label)

        self.Hawk01_curvature_SpinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_correct_thres_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_correct_thres_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(5, QFormLayout.LabelRole, self.Hawk01_correct_thres_Label)

        self.Hawk01_correct_thres_SpinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_cali_order_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_cali_order_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(6, QFormLayout.LabelRole, self.Hawk01_cali_order_Label)

        self.Hawk01_cali_order_ComboBox = NoWheelComboBox(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_cali_frm_num_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_cali_frm_num_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(7, QFormLayout.LabelRole, self.Hawk01_cali_frm_num_Label)

        self.Hawk01_cali_frm_num__SpinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_ref_segment_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_ref_segment_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(8, QFormLayout.LabelRole, self.Hawk01_ref_segment_Label)

        self.Hawk01_ref_segment_SpinBox = NoWheelSpinBox(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_mode_2D_Label = QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.Hawk01_mode_2D_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_7.setWidget(9, QFormLayout.LabelRole, self.Hawk01_mode_2D_Label)

        self.Hawk01_mode_2D_ComboBox = NoWheelComboBox(self.scrollAreaWidgetContents_6)
...
"}")
        self.Hawk01_ROIZoneConfig.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.Hawk01_file_save_dir_Label.setFrameShape(QFrame.NoFrame)
        self.Hawk01_file_save_dir_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Hawk01_reference_script_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.Hawk01_Save.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.Hawk01_Open.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.Hawk01_reference_script_Label.setFrameShape(QFrame.NoFrame)
        self.Hawk01_reference_script_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Hawk01_file_save_dir_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.Swan01_RegisterConfig = QWidget(self.Swan01_ScriptConfig)
        self.Swan01_RegisterConfig.setObjectName(u"Swan01_RegisterConfig")
        self.Swan01_RegisterConfig.setMinimumSize(QSize(0, 0))
        self.Swan01_RegisterConfig.setMaximumSize(QSize(600, 16777215))
        self.formLayout_6 = QFormLayout(self.Swan01_RegisterConfig)
        self.formLayout_6.setObjectName(u"formLayout_6")
        self.formLayout_6.setVerticalSpacing(8)
        self.formLayout_6.setContentsMargins(3, 0, 3, 0)
        self.Swan01_XCLK_Label = QLabel(self.Swan01_RegisterConfig)
        self.Swan01_XCLK_Label.setObjectName(u"Swan01_XCLK_Label")
        self.Swan01_XCLK_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_XCLK_Label.setFont(font)
        self.Swan01_XCLK_Label.setFrameShape(QFrame.StyledPanel)

        self.formLayout_6.setWidget(0, QFormLayout.LabelRole, self.Swan01_XCLK_Label)

        self.Swan01_XCLK_ComboBox = QComboBox(self.Swan01_RegisterConfig)
        ...
        self.Swan01_XCLK_ComboBox.setMaximumSize(QSize(350, 16777215))
        self.Swan01_XCLK_ComboBox.setFont(font1)

        self.formLayout_6.setWidget(0, QFormLayout.FieldRole, self.Swan01_XCLK_ComboBox)

        self.Swan01_MST_MODE_Label = QLabel(self.Swan01_RegisterConfig)
        self.Swan01_MST_MODE_Label.setObjectName(u"Swan01_MST_MODE_Label")
        self.Swan01_MST_MODE_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_MST_MODE_Label.setMaximumSize(QSize(85, 16777215))
        self.Swan01_MST_MODE_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_MST_MODE_Label.setMargin(0)

        self.formLayout_6.setWidget(1, QFormLayout.LabelRole, self.Swan01_MST_MODE_Label)

        self.Swan01_MST_MODE_ComboBox = QComboBox(self.Swan01_RegisterConfig)
        self.Swan01_MST_MODE_ComboBox.addItem("")
        self.Swan01_MST_MODE_ComboBox.addItem("")
        self.Swan01_MST_MODE_ComboBox.setObjectName(u"Swan01_MST_MODE_ComboBox")
        self.Swan01_MST_MODE_ComboBox.setMaximumSize(QSize(350, 16777215))

        self.formLayout_6.setWidget(1, QFormLayout.FieldRole, self.Swan01_MST_MODE_ComboBox)

        self.Swan01_TX_FRM_MODE_Label = QLabel(self.Swan01_RegisterConfig)
        self.Swan01_TX_FRM_MODE_Label.setObjectName(u"Swan01_TX_FRM_MODE_Label")
        self.Swan01_TX_FRM_MODE_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_TX_FRM_MODE_Label.setMaximumSize(QSize(85, 16777215))
        self.Swan01_TX_FRM_MODE_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_TX_FRM_MODE_Label.setMargin(0)

        self.formLayout_6.setWidget(2, QFormLayout.LabelRole, self.Swan01_TX_FRM_MODE_Label)

        self.Swan01_WORK_MODE_Label = QLabel(self.Swan01_RegisterConfig)
        ...
        self.Swan01_WORK_MODE_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_WORK_MODE_Label.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_WORK_MODE_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_WORK_MODE_Label.setFrameShadow(QFrame.Raised)
        self.Swan01_WORK_MODE_Label.setMargin(0)

        self.formLayout_6.setWidget(3, QFormLayout.LabelRole, self.Swan01_WORK_MODE_Label)

        self.Swan01_WORK_MODE_ComboBox = ComboCheckBox(self.Swan01_RegisterConfig)
        self.Swan01_WORK_MODE_ComboBox.addItem("")
        self.Swan01_WORK_MODE_ComboBox.addItem("")
        self.Swan01_WORK_MODE_ComboBox.addItem("")
        self.Swan01_WORK_MODE_ComboBox.addItem("")
        self.Swan01_WORK_MODE_ComboBox.setObjectName(u"Swan01_WORK_MODE_ComboBox")
        self.Swan01_WORK_MODE_ComboBox.setMaximumSize(QSize(350, 16777215))
        self.Swan01_WORK_MODE_ComboBox.setFont(font1)

        self.formLayout_6.setWidget(3, QFormLayout.FieldRole, self.Swan01_WORK_MODE_ComboBox)

        self.Swan01_MIPI_RATE_Label = QLabel(self.Swan01_RegisterConfig)
        ...
        self.Swan01_MIPI_RATE_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_MIPI_RATE_Label.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_MIPI_RATE_Label.setFont(font1)
        self.Swan01_MIPI_RATE_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_MIPI_RATE_Label.setFrameShadow(QFrame.Raised)

        self.formLayout_6.setWidget(4, QFormLayout.LabelRole, self.Swan01_MIPI_RATE_Label)

        self.Swan01_MIPI_RATE_ComboBox = QComboBox(self.Swan01_RegisterConfig)
        self.Swan01_MIPI_RATE_ComboBox.addItem("")
        self.Swan01_MIPI_RATE_ComboBox.addItem("")
        self.Swan01_MIPI_RATE_ComboBox.addItem("")
        self.Swan01_MIPI_RATE_ComboBox.addItem("")
        self.Swan01_MIPI_RATE_ComboBox.setObjectName(u"Swan01_MIPI_RATE_ComboBox")
        self.Swan01_MIPI_RATE_ComboBox.setMaximumSize(QSize(350, 16777215))
        self.Swan01_MIPI_RATE_ComboBox.setFont(font1)

        self.formLayout_6.setWidget(4, QFormLayout.FieldRole, self.Swan01_MIPI_RATE_ComboBox)

        self.Swan01_MoreConfiguration = QGroupBox(self.Swan01_RegisterConfig)
        self.Swan01_MoreConfiguration.setObjectName(u"Swan01_MoreConfiguration")
        self.Swan01_MoreConfiguration.setMinimumSize(QSize(438, 180))
        self.Swan01_MoreConfiguration.setMaximumSize(QSize(445, 16777215))
        self.Swan01_MoreConfiguration.setStyleSheet(u"")
        self.gridLayout_3 = QGridLayout(self.Swan01_MoreConfiguration)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.gridLayout_3.setContentsMargins(0, -1, 3, -1)
        self.Swan01_V_PXL_OUT_NUM_ComboBox = QComboBox(self.Swan01_MoreConfiguration)
        self.Swan01_V_PXL_OUT_NUM_ComboBox.addItem("")
        self.Swan01_V_PXL_OUT_NUM_ComboBox.addItem("")
        self.Swan01_V_PXL_OUT_NUM_ComboBox.setObjectName(u"Swan01_V_PXL_OUT_NUM_ComboBox")

        self.gridLayout_3.addWidget(self.Swan01_V_PXL_OUT_NUM_ComboBox, 1, 1, 1, 1)

        self.Swan01_TRG_I_EN_Label = QLabel(self.Swan01_MoreConfiguration)
        self.Swan01_TRG_I_EN_Label.setObjectName(u"Swan01_TRG_I_EN_Label")
        self.Swan01_TRG_I_EN_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_TRG_I_EN_Label.setMaximumSize(QSize(85, 16777215))
        self.Swan01_TRG_I_EN_Label.setFont(font)
        self.Swan01_TRG_I_EN_Label.setFrameShape(QFrame.StyledPanel)

        self.gridLayout_3.addWidget(self.Swan01_TRG_I_EN_Label, 1, 3, 1, 1)

        self.Swan01_OUT_BIN_NUM_Lable = QLabel(self.Swan01_MoreConfiguration)
        self.Swan01_OUT_BIN_NUM_Lable.setObjectName(u"Swan01_OUT_BIN_NUM_Lable")
        self.Swan01_OUT_BIN_NUM_Lable.setMinimumSize(QSize(100, 0))
        self.Swan01_OUT_BIN_NUM_Lable.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_OUT_BIN_NUM_Lable.setFont(font)
        self.Swan01_OUT_BIN_NUM_Lable.setFrameShape(QFrame.StyledPanel)

        self.gridLayout_3.addWidget(self.Swan01_OUT_BIN_NUM_Lable, 3, 0, 1, 1)

        self.Swan01_SYS_CLK_Label = QLabel(self.Swan01_MoreConfiguration)
        self.Swan01_SYS_CLK_Label.setObjectName(u"Swan01_SYS_CLK_Label")
        self.Swan01_SYS_CLK_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_SYS_CLK_Label.setFont(font)
        self.Swan01_SYS_CLK_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_SYS_CLK_Label.setFrameShadow(QFrame.Raised)

        self.gridLayout_3.addWidget(self.Swan01_SYS_CLK_Label, 0, 0, 1, 1)

        self.Swan01_PKS_ECHO_NUM_Lable = QLabel(self.Swan01_MoreConfiguration)
        self.Swan01_PKS_ECHO_NUM_Lable.setObjectName(u"Swan01_PKS_ECHO_NUM_Lable")
        self.Swan01_PKS_ECHO_NUM_Lable.setMinimumSize(QSize(100, 0))
        self.Swan01_PKS_ECHO_NUM_Lable.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_PKS_ECHO_NUM_Lable.setFont(font)
        self.Swan01_PKS_ECHO_NUM_Lable.setFrameShape(QFrame.StyledPanel)

        self.gridLayout_3.addWidget(self.Swan01_PKS_ECHO_NUM_Lable, 3, 3, 1, 1)

        self.Swan01_MINBIN_THRS_Lable = QLabel(self.Swan01_MoreConfiguration)
        self.Swan01_MINBIN_THRS_Lable.setObjectName(u"Swan01_MINBIN_THRS_Lable")
        self.Swan01_MINBIN_THRS_Lable.setMinimumSize(QSize(100, 0))
        self.Swan01_MINBIN_THRS_Lable.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_MINBIN_THRS_Lable.setFont(font)
        self.Swan01_MINBIN_THRS_Lable.setFrameShape(QFrame.StyledPanel)

        self.gridLayout_3.addWidget(self.Swan01_MINBIN_THRS_Lable, 2, 0, 1, 1)

        self.verticalSpacer_5 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_3.addItem(self.verticalSpacer_5, 6, 1, 1, 1)

        self.Swan01_PKS_ECHO_NUM_ComboBox = QComboBox(self.Swan01_MoreConfiguration)
        self.Swan01_PKS_ECHO_NUM_ComboBox.addItem("")
        self.Swan01_PKS_ECHO_NUM_ComboBox.addItem("")
        self.Swan01_PKS_ECHO_NUM_ComboBox.addItem("")
        self.Swan01_PKS_ECHO_NUM_ComboBox.addItem("")
        self.Swan01_PKS_ECHO_NUM_ComboBox.addItem("")
        self.Swan01_PKS_ECHO_NUM_ComboBox.setObjectName(u"Swan01_PKS_ECHO_NUM_ComboBox")

        self.gridLayout_3.addWidget(self.Swan01_PKS_ECHO_NUM_ComboBox, 3, 5, 1, 1)

        self.Swan01_MAXBIN_THRS_spinBox = QSpinBox(self.Swan01_MoreConfiguration)
        self.Swan01_MAXBIN_THRS_spinBox.setObjectName(u"Swan01_MAXBIN_THRS_spinBox")
        self.Swan01_MAXBIN_THRS_spinBox.setMinimumSize(QSize(60, 0))
        self.Swan01_MAXBIN_THRS_spinBox.setMinimum(1)
        self.Swan01_MAXBIN_THRS_spinBox.setMaximum(167)
        self.Swan01_MAXBIN_THRS_spinBox.setValue(167)

        self.gridLayout_3.addWidget(self.Swan01_MAXBIN_THRS_spinBox, 2, 5, 1, 1)

        self.Swan01_MAXBIN_THRS_Lable_ = QLabel(self.Swan01_MoreConfiguration)
        self.Swan01_MAXBIN_THRS_Lable_.setObjectName(u"Swan01_MAXBIN_THRS_Lable_")
        self.Swan01_MAXBIN_THRS_Lable_.setMinimumSize(QSize(100, 0))
        self.Swan01_MAXBIN_THRS_Lable_.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_MAXBIN_THRS_Lable_.setFont(font)
        self.Swan01_MAXBIN_THRS_Lable_.setFrameShape(QFrame.StyledPanel)

        self.gridLayout_3.addWidget(self.Swan01_MAXBIN_THRS_Lable_, 2, 3, 1, 1)

        self.Swan01_V_PXL_OUT_NUM_Label = QLabel(self.Swan01_MoreConfiguration)
        self.Swan01_V_PXL_OUT_NUM_Label.setObjectName(u"Swan01_V_PXL_OUT_NUM_Label")
        self.Swan01_V_PXL_OUT_NUM_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_V_PXL_OUT_NUM_Label.setMaximumSize(QSize(85, 16777215))
        self.Swan01_V_PXL_OUT_NUM_Label.setFont(font)
        self.Swan01_V_PXL_OUT_NUM_Label.setFrameShape(QFrame.StyledPanel)

        self.gridLayout_3.addWidget(self.Swan01_V_PXL_OUT_NUM_Label, 1, 0, 1, 1)

        self.Swan01_SYS_CLK_ComboBox = QComboBox(self.Swan01_MoreConfiguration)
        self.Swan01_SYS_CLK_ComboBox.addItem("")
        self.Swan01_SYS_CLK_ComboBox.addItem("")
        self.Swan01_SYS_CLK_ComboBox.addItem("")
        self.Swan01_SYS_CLK_ComboBox.setObjectName(u"Swan01_SYS_CLK_ComboBox")
        self.Swan01_SYS_CLK_ComboBox.setEnabled(False)
        self.Swan01_SYS_CLK_ComboBox.setMinimumSize(QSize(10, 0))
        self.Swan01_SYS_CLK_ComboBox.setFont(font1)
        self.Swan01_SYS_CLK_ComboBox.setEditable(False)

        self.gridLayout_3.addWidget(self.Swan01_SYS_CLK_ComboBox, 0, 1, 1, 1)

        self.horizontalSpacer_25 = QSpacerItem(10, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.gridLayout_3.addItem(self.horizontalSpacer_25, 1, 2, 1, 1)

        self.Swan01_TRG_I_EN_ComboBox = QComboBox(self.Swan01_MoreConfiguration)
        self.Swan01_TRG_I_EN_ComboBox.addItem("")
        self.Swan01_TRG_I_EN_ComboBox.addItem("")
        self.Swan01_TRG_I_EN_ComboBox.setObjectName(u"Swan01_TRG_I_EN_ComboBox")

        self.gridLayout_3.addWidget(self.Swan01_TRG_I_EN_ComboBox, 1, 5, 1, 1)

        self.Swan01_MINBIN_THRS_spinBox = QSpinBox(self.Swan01_MoreConfiguration)
        self.Swan01_MINBIN_THRS_spinBox.setObjectName(u"Swan01_MINBIN_THRS_spinBox")
        self.Swan01_MINBIN_THRS_spinBox.setEnabled(True)
        self.Swan01_MINBIN_THRS_spinBox.setMinimumSize(QSize(60, 0))
        self.Swan01_MINBIN_THRS_spinBox.setMinimum(0)
        self.Swan01_MINBIN_THRS_spinBox.setMaximum(255)
        self.Swan01_MINBIN_THRS_spinBox.setValue(0)

        self.gridLayout_3.addWidget(self.Swan01_MINBIN_THRS_spinBox, 2, 1, 1, 1)

        self.Swan01_OUT_BIN_NUM_ComboBox = QComboBox(self.Swan01_MoreConfiguration)
        self.Swan01_OUT_BIN_NUM_ComboBox.addItem("")
        self.Swan01_OUT_BIN_NUM_ComboBox.addItem("")
        self.Swan01_OUT_BIN_NUM_ComboBox.setObjectName(u"Swan01_OUT_BIN_NUM_ComboBox")

        self.gridLayout_3.addWidget(self.Swan01_OUT_BIN_NUM_ComboBox, 3, 1, 1, 1)

        self.Swan01_BIN_NUMBER_Value = QLabel(self.Swan01_MoreConfiguration)
        self.Swan01_BIN_NUMBER_Value.setObjectName(u"Swan01_BIN_NUMBER_Value")
        self.Swan01_BIN_NUMBER_Value.setMinimumSize(QSize(25, 25))
        self.Swan01_BIN_NUMBER_Value.setMaximumSize(QSize(20, 16777215))
        self.Swan01_BIN_NUMBER_Value.setFont(font1)
        self.Swan01_BIN_NUMBER_Value.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.Swan01_BIN_NUMBER_Value.setWordWrap(True)
        self.Swan01_BIN_NUMBER_Value.setMargin(0)

        self.gridLayout_3.addWidget(self.Swan01_BIN_NUMBER_Value, 2, 6, 1, 1)


        self.formLayout_6.setWidget(5, QFormLayout.SpanningRole, self.Swan01_MoreConfiguration)

        self.Swan01_TX_FRM_MODE_ComboBox = QComboBox(self.Swan01_RegisterConfig)
        self.Swan01_TX_FRM_MODE_ComboBox.addItem("")
        self.Swan01_TX_FRM_MODE_ComboBox.addItem("")
        self.Swan01_TX_FRM_MODE_ComboBox.setObjectName(u"Swan01_TX_FRM_MODE_ComboBox")
        self.Swan01_TX_FRM_MODE_ComboBox.setMaximumSize(QSize(350, 16777215))

        self.formLayout_6.setWidget(2, QFormLayout.FieldRole, self.Swan01_TX_FRM_MODE_ComboBox)
        ...
        self.formLayout_8.setVerticalSpacing(8)
        self.formLayout_8.setContentsMargins(9, 0, 9, 9)
        self.Swan01_SCAN_MODE_Label = QLabel(self.Swan01_ROIConfigGroup)
        self.Swan01_SCAN_MODE_Label.setObjectName(u"Swan01_SCAN_MODE_Label")
        self.Swan01_SCAN_MODE_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_SCAN_MODE_Label.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_SCAN_MODE_Label.setFont(font1)
        self.Swan01_SCAN_MODE_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_SCAN_MODE_Label.setFrameShadow(QFrame.Raised)

        self.formLayout_8.setWidget(0, QFormLayout.LabelRole, self.Swan01_SCAN_MODE_Label)

        self.Swan01_SCAN_MODE_ComboBox = QComboBox(self.Swan01_ROIConfigGroup)
        self.Swan01_SCAN_MODE_ComboBox.addItem("")
        self.Swan01_SCAN_MODE_ComboBox.addItem("")
        self.Swan01_SCAN_MODE_ComboBox.setObjectName(u"Swan01_SCAN_MODE_ComboBox")
        self.Swan01_SCAN_MODE_ComboBox.setMinimumSize(QSize(150, 0))
        self.Swan01_SCAN_MODE_ComboBox.setMaximumSize(QSize(300, 16777215))
        self.Swan01_SCAN_MODE_ComboBox.setFont(font1)

        self.formLayout_8.setWidget(0, QFormLayout.FieldRole, self.Swan01_SCAN_MODE_ComboBox)

        self.Swan01_V_ROLL_NUM_Label = QLabel(self.Swan01_ROIConfigGroup)
        self.Swan01_V_ROLL_NUM_Label.setObjectName(u"Swan01_V_ROLL_NUM_Label")
        self.Swan01_V_ROLL_NUM_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_V_ROLL_NUM_Label.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_V_ROLL_NUM_Label.setFont(font1)
        self.Swan01_V_ROLL_NUM_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_V_ROLL_NUM_Label.setFrameShadow(QFrame.Raised)

        self.formLayout_8.setWidget(1, QFormLayout.LabelRole, self.Swan01_V_ROLL_NUM_Label)

        self.Swan01_H_ROLL_NUM_Label = QLabel(self.Swan01_ROIConfigGroup)
        self.Swan01_H_ROLL_NUM_Label.setObjectName(u"Swan01_H_ROLL_NUM_Label")
        self.Swan01_H_ROLL_NUM_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_H_ROLL_NUM_Label.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_H_ROLL_NUM_Label.setFont(font1)
        self.Swan01_H_ROLL_NUM_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_H_ROLL_NUM_Label.setFrameShadow(QFrame.Raised)

        self.formLayout_8.setWidget(2, QFormLayout.LabelRole, self.Swan01_H_ROLL_NUM_Label)

        self.Swan01_H_VLD_SEG_Label = QLabel(self.Swan01_ROIConfigGroup)
        self.Swan01_H_VLD_SEG_Label.setObjectName(u"Swan01_H_VLD_SEG_Label")
        self.Swan01_H_VLD_SEG_Label.setMinimumSize(QSize(100, 0))
        self.Swan01_H_VLD_SEG_Label.setMaximumSize(QSize(16777215, 16777215))
        self.Swan01_H_VLD_SEG_Label.setFont(font1)
        self.Swan01_H_VLD_SEG_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_H_VLD_SEG_Label.setFrameShadow(QFrame.Raised)

        self.formLayout_8.setWidget(3, QFormLayout.LabelRole, self.Swan01_H_VLD_SEG_Label)

        self.Swan01_H_ROLL_NUM_Frame = QFrame(self.Swan01_ROIConfigGroup)
        self.Swan01_H_ROLL_NUM_Frame.setObjectName(u"Swan01_H_ROLL_NUM_Frame")
        self.H_ROLL_CMP_2 = QHBoxLayout(self.Swan01_H_ROLL_NUM_Frame)
        self.H_ROLL_CMP_2.setSpacing(0)
        self.H_ROLL_CMP_2.setObjectName(u"H_ROLL_CMP_2")
        self.H_ROLL_CMP_2.setContentsMargins(0, 0, 0, 0)
        self.Swan01_H_ROLL_NUM_Slider = QSlider(self.Swan01_H_ROLL_NUM_Frame)
        self.Swan01_H_ROLL_NUM_Slider.setObjectName(u"Swan01_H_ROLL_NUM_Slider")
        self.Swan01_H_ROLL_NUM_Slider.setEnabled(True)
        self.Swan01_H_ROLL_NUM_Slider.setMinimum(1)
        self.Swan01_H_ROLL_NUM_Slider.setMaximum(16)
        self.Swan01_H_ROLL_NUM_Slider.setPageStep(1)
        self.Swan01_H_ROLL_NUM_Slider.setOrientation(Qt.Horizontal)

        self.H_ROLL_CMP_2.addWidget(self.Swan01_H_ROLL_NUM_Slider)

        self.Swan01_H_ROLL_NUM_Value = QLabel(self.Swan01_H_ROLL_NUM_Frame)
        self.Swan01_H_ROLL_NUM_Value.setObjectName(u"Swan01_H_ROLL_NUM_Value")
        self.Swan01_H_ROLL_NUM_Value.setMinimumSize(QSize(20, 25))
        self.Swan01_H_ROLL_NUM_Value.setMaximumSize(QSize(20, 16777215))
        self.Swan01_H_ROLL_NUM_Value.setFont(font1)
        self.Swan01_H_ROLL_NUM_Value.setMidLineWidth(0)
        self.Swan01_H_ROLL_NUM_Value.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.Swan01_H_ROLL_NUM_Value.setMargin(0)

        self.H_ROLL_CMP_2.addWidget(self.Swan01_H_ROLL_NUM_Value)


        self.formLayout_8.setWidget(2, QFormLayout.FieldRole, self.Swan01_H_ROLL_NUM_Frame)

        self.Swan01_V_ROLL_NUM_Frame = QFrame(self.Swan01_ROIConfigGroup)
        self.Swan01_V_ROLL_NUM_Frame.setObjectName(u"Swan01_V_ROLL_NUM_Frame")
        self.V_ROLL_NUM_CMP_2 = QHBoxLayout(self.Swan01_V_ROLL_NUM_Frame)
        self.V_ROLL_NUM_CMP_2.setSpacing(0)
        self.V_ROLL_NUM_CMP_2.setObjectName(u"V_ROLL_NUM_CMP_2")
        self.V_ROLL_NUM_CMP_2.setContentsMargins(0, 0, 0, 0)
        self.Swan01_V_ROLL_NUM_Slider = QSlider(self.Swan01_V_ROLL_NUM_Frame)
        self.Swan01_V_ROLL_NUM_Slider.setObjectName(u"Swan01_V_ROLL_NUM_Slider")
        self.Swan01_V_ROLL_NUM_Slider.setMouseTracking(False)
        self.Swan01_V_ROLL_NUM_Slider.setMinimum(1)
        self.Swan01_V_ROLL_NUM_Slider.setMaximum(32)
        self.Swan01_V_ROLL_NUM_Slider.setPageStep(1)
        self.Swan01_V_ROLL_NUM_Slider.setOrientation(Qt.Horizontal)

        self.V_ROLL_NUM_CMP_2.addWidget(self.Swan01_V_ROLL_NUM_Slider)

        self.Swan01_V_ROLL_NUM_Value = QLabel(self.Swan01_V_ROLL_NUM_Frame)
        self.Swan01_V_ROLL_NUM_Value.setObjectName(u"Swan01_V_ROLL_NUM_Value")
        self.Swan01_V_ROLL_NUM_Value.setMinimumSize(QSize(20, 25))
        self.Swan01_V_ROLL_NUM_Value.setMaximumSize(QSize(20, 16777215))
        self.Swan01_V_ROLL_NUM_Value.setFont(font1)
        self.Swan01_V_ROLL_NUM_Value.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.Swan01_V_ROLL_NUM_Value.setWordWrap(True)
        self.Swan01_V_ROLL_NUM_Value.setMargin(0)

        self.V_ROLL_NUM_CMP_2.addWidget(self.Swan01_V_ROLL_NUM_Value)


        self.formLayout_8.setWidget(1, QFormLayout.FieldRole, self.Swan01_V_ROLL_NUM_Frame)

        self.Swan01_H_VLD_SEG_Frame = QFrame(self.Swan01_ROIConfigGroup)
        self.Swan01_H_VLD_SEG_Frame.setObjectName(u"Swan01_H_VLD_SEG_Frame")
        self.H_VLD_SEG_CMP_2 = QHBoxLayout(self.Swan01_H_VLD_SEG_Frame)
        self.H_VLD_SEG_CMP_2.setSpacing(0)
        self.H_VLD_SEG_CMP_2.setObjectName(u"H_VLD_SEG_CMP_2")
        self.H_VLD_SEG_CMP_2.setContentsMargins(0, 0, 0, 0)
        self.Swan01_H_VLD_SEG_Slider = QSlider(self.Swan01_H_VLD_SEG_Frame)
        self.Swan01_H_VLD_SEG_Slider.setObjectName(u"Swan01_H_VLD_SEG_Slider")
        self.Swan01_H_VLD_SEG_Slider.setMinimum(1)
        self.Swan01_H_VLD_SEG_Slider.setMaximum(16)
        self.Swan01_H_VLD_SEG_Slider.setPageStep(1)
        self.Swan01_H_VLD_SEG_Slider.setOrientation(Qt.Horizontal)

        self.H_VLD_SEG_CMP_2.addWidget(self.Swan01_H_VLD_SEG_Slider)

        self.Swan01_H_VLD_SEG_Value = QLabel(self.Swan01_H_VLD_SEG_Frame)
        self.Swan01_H_VLD_SEG_Value.setObjectName(u"Swan01_H_VLD_SEG_Value")
        self.Swan01_H_VLD_SEG_Value.setMinimumSize(QSize(20, 25))
        self.Swan01_H_VLD_SEG_Value.setMaximumSize(QSize(20, 16777215))
        self.Swan01_H_VLD_SEG_Value.setFont(font1)
        self.Swan01_H_VLD_SEG_Value.setTextFormat(Qt.MarkdownText)
        self.Swan01_H_VLD_SEG_Value.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.Swan01_H_VLD_SEG_Value.setMargin(0)

        self.H_VLD_SEG_CMP_2.addWidget(self.Swan01_H_VLD_SEG_Value)


        self.formLayout_8.setWidget(3, QFormLayout.FieldRole, self.Swan01_H_VLD_SEG_Frame)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QRect(0, 0, 330, 392))
        ...
        self.Swan01_seg_hs_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_seg_hs_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_spad_vs_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_spad_vs_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_light_shift_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_light_shift_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_sublight_shift_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_sublight_shift_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_ROI_Shape_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_ROI_Shape_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_v_spad_shift_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_v_spad_shift_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_h_seg_shift_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_h_seg_shift_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_ROI_Retrace_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_ROI_Retrace_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_sublight_group_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_sublight_group_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_sublight_group_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 330, 392))
        ...
        self.Swan01_Cali_File_Load_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_Cali_File_Load_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_Cali_File_Load_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.Swan01_Cali_File_Load_Button.setFocusPolicy(Qt.WheelFocus)
        ...
        self.Swan01_Excel_Sheet_sel_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_Excel_Sheet_sel_Label.setFrameShadow(QFrame.Raised)
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QRect(0, 0, 330, 392))
        ...
        self.Swan01_ROI_File_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_ROI_File_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.Swan01_ROI_File_Button.setFocusPolicy(Qt.WheelFocus)
        ...
        self.Swan01_Start_Rolling_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_Start_Rolling_Label.setFrameShadow(QFrame.Raised)
        self.Swan01_Start_Rolling_Label.setTextFormat(Qt.PlainText)
        ...
        self.Swan01_End_Rolling_Label.setFrameShape(QFrame.StyledPanel)
        self.Swan01_End_Rolling_Label.setFrameShadow(QFrame.Raised)
        ...
        self.scrollAreaWidgetContents_9.setGeometry(QRect(0, 0, 330, 383))
        ...
        self.Swan01_cali_file_path_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_cali_file_path_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.Swan01_cali_file_path_Button.setFocusPolicy(Qt.WheelFocus)
        ...
        self.Swan01_img_mirror_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_remove_noise_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_light_smooth_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_curvature_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_correct_thres_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_cali_order_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_cali_frm_num_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_ref_segment_Label.setFrameShape(QFrame.StyledPanel)
        ...
        self.Swan01_mode_2D_Label.setFrameShape(QFrame.StyledPanel)
...
"font: 700 9pt \"Consolas\";\n"
"}")
        self.Swan01_ROIZoneConfig.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.Swan01_file_save_dir_Label.setFrameShape(QFrame.NoFrame)
        self.Swan01_file_save_dir_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_reference_script_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.Swan01_Save.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.Swan01_Open.setCursor(QCursor(Qt.PointingHandCursor))
        ...
        self.Swan01_reference_script_Label.setFrameShape(QFrame.NoFrame)
        self.Swan01_reference_script_Label.setFrameShadow(QFrame.Raised)
        ...
        self.Swan01_file_save_dir_LineEdit.setFocusPolicy(Qt.StrongFocus)
        ...
        self.contents.setGeometry(QRect(0, 0, 882, 784))
    ...
    def retranslateUi(self, MainPages):
        ...
        self.Swan01_WORK_MODE_ComboBox.setItemText(0, QCoreApplication.translate("MainPages", u"Ranging Mode", None))
        self.Swan01_WORK_MODE_ComboBox.setItemText(1, QCoreApplication.translate("MainPages", u"Echo Mode", None))
        self.Swan01_WORK_MODE_ComboBox.setItemText(2, QCoreApplication.translate("MainPages", u"Histogram Mode", None))
        self.Swan01_WORK_MODE_ComboBox.setItemText(3, QCoreApplication.translate("MainPages", u"Gray Scale Mode", None))
        ...
        self.Swan01_MoreConfiguration.setTitle("")
        self.Swan01_V_PXL_OUT_NUM_ComboBox.setItemText(0, QCoreApplication.translate("MainPages", u"1 Pixel", None))
        self.Swan01_V_PXL_OUT_NUM_ComboBox.setItemText(1, QCoreApplication.translate("MainPages", u"6 Pixel", None))

        self.Swan01_TRG_I_EN_Label.setText(QCoreApplication.translate("MainPages", u"TRG_I_EN", None))
        self.Swan01_OUT_BIN_NUM_Lable.setText(QCoreApplication.translate("MainPages", u"OUT_BIN_NUM", None))
        self.Swan01_SYS_CLK_Label.setText(QCoreApplication.translate("MainPages", u"SYS CLK", None))
        self.Swan01_PKS_ECHO_NUM_Lable.setText(QCoreApplication.translate("MainPages", u"PKS_ECHO_NUM", None))
        self.Swan01_MINBIN_THRS_Lable.setText(QCoreApplication.translate("MainPages", u"MINBIN_THRS", None))
        self.Swan01_PKS_ECHO_NUM_ComboBox.setItemText(0, QCoreApplication.translate("MainPages", u"1 Echo", None))
        self.Swan01_PKS_ECHO_NUM_ComboBox.setItemText(1, QCoreApplication.translate("MainPages", u"2 Echo", None))
        self.Swan01_PKS_ECHO_NUM_ComboBox.setItemText(2, QCoreApplication.translate("MainPages", u"3 Echo", None))
        self.Swan01_PKS_ECHO_NUM_ComboBox.setItemText(3, QCoreApplication.translate("MainPages", u"4 Echo", None))
        self.Swan01_PKS_ECHO_NUM_ComboBox.setItemText(4, QCoreApplication.translate("MainPages", u"5 Echo", None))

#if QT_CONFIG(tooltip)
        self.Swan01_MAXBIN_THRS_spinBox.setToolTip(QCoreApplication.translate("MainPages", u"MAXBIN_THRS", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.Swan01_MAXBIN_THRS_spinBox.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.Swan01_MAXBIN_THRS_Lable_.setText(QCoreApplication.translate("MainPages", u"MAXBIN_THRS", None))
        self.Swan01_V_PXL_OUT_NUM_Label.setText(QCoreApplication.translate("MainPages", u"V_PXL_NUM", None))
        self.Swan01_SYS_CLK_ComboBox.setItemText(0, QCoreApplication.translate("MainPages", u"200 M", None))
        self.Swan01_SYS_CLK_ComboBox.setItemText(1, QCoreApplication.translate("MainPages", u"250 M", None))
        self.Swan01_SYS_CLK_ComboBox.setItemText(2, QCoreApplication.translate("MainPages", u"330 M", None))
...
#if QT_CONFIG(tooltip)
        self.Swan01_MINBIN_THRS_spinBox.setToolTip(QCoreApplication.translate("MainPages", u"MINBIN_THRS", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.Swan01_MINBIN_THRS_spinBox.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.Swan01_OUT_BIN_NUM_ComboBox.setItemText(0, QCoreApplication.translate("MainPages", u"36 Bin", None))
        self.Swan01_OUT_BIN_NUM_ComboBox.setItemText(1, QCoreApplication.translate("MainPages", u"60 Bin", None))

        self.Swan01_BIN_NUMBER_Value.setText(QCoreApplication.translate("MainPages", u"672", None))
        ...
        self.Swan01_SCAN_MODE_Label.setText(QCoreApplication.translate("MainPages", u"SCAN_MODE", None))
        self.Swan01_SCAN_MODE_ComboBox.setItemText(0, QCoreApplication.translate("MainPages", u"1D SCAN_MODE", None))
        self.Swan01_SCAN_MODE_ComboBox.setItemText(1, QCoreApplication.translate("MainPages", u"2D SCAN_MODE", None))

        self.Swan01_V_ROLL_NUM_Label.setText(QCoreApplication.translate("MainPages", u"V_ROLL_NUM", None))
        self.Swan01_H_ROLL_NUM_Label.setText(QCoreApplication.translate("MainPages", u"H_ROLL_NUM", None))
        self.Swan01_H_VLD_SEG_Label.setText(QCoreApplication.translate("MainPages", u"H_VLD_SEG", None))
        self.Swan01_H_ROLL_NUM_Value.setText(QCoreApplication.translate("MainPages", u"1", None))
        self.Swan01_V_ROLL_NUM_Value.setText(QCoreApplication.translate("MainPages", u"1", None))
        self.Swan01_H_VLD_SEG_Value.setText(QCoreApplication.translate("MainPages", u"1", None))
