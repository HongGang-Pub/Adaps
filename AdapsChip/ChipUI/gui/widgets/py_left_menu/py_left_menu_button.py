...
# ///////////////////////////////////////////////////////////////
import os
from AdapsChip.ChipUI.gui.core.json_settings import Settings
...
# IMPORT FUNCTIONS
# ///////////////////////////////////////////////////////////////
from AdapsChip.ChipUI.gui.core.functions import *
...
class PyLeftMenuButton(QPushButton):
    def __init__(
        ...
        super().__init__()
        self.tips_minimum = tips_minimum
        self.setText(text)
    ...
    def paintEvent(self, event):
        ...
        rect_inside = QRect(0, 5, self.width(), self.height() - 10)
        rect_icon = QRect(0, 0, 40, self.height())
        rect_blue = QRect(0, 5, 20, self.height() - 10)
        rect_inside_active = QRect(0, 5, self.width(), self.height() - 10)
        rect_text = QRect(40, 0, self.width() - 50, self.height())
    ...
    def enterEvent(self, event):
        ...
        if self.width() == self.tips_minimum-10 and self._tooltip_text:
            self.move_tooltip()
            self.tooltip.show()
    ...
    def move_tooltip(self):
        ...
        pos_y = pos.y() + (self.height() - self.tooltip.height()) // 2
